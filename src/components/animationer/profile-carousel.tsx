...
const profiles = [
  {
    id: 1,
    name: "Viola",
    image: "src/assets/images/profil/Viola.webp",
    description: [
  ...
  },
  {
    id: 2,
    name: "Rich",
    image: "src/assets/images/profil/Rich.webp",
    description: [
  ...
  },
  {
    id: 3,
    name: "Gerard",
    image: "src/assets/images/profil/Gerard.webp",
    description: [
  ...
  },
  {
    id: 4,
    name: "Caro",
    image: "src/assets/images/profil/Caro.webp",
    description: [
  ...
  },
  {
    id: 5,
    name: "Silke",
    image: "src/assets/images/profil/Silke.webp",
    description: [
        ...
        <div className="md:w-3/5 p-6 md:p-8 text-white relative flex flex-col self-center">
          ...
          <div className="mt-auto pt-4">
            <div className="flex items-center justify-end">
              ...
              >
                <img src="src/assets/images/icons/Arrow.svg" alt="Previous" />
              </button>
              <img
